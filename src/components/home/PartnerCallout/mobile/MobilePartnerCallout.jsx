import './_mobilePartnerCallout.scss';

export default function MobilePartnerCallout() {
  return (
    <section className="mobile-partner-callout-section">
      <div className="mobile-callout-container">
        <div className="mobile-callout-box">
          <div className="mobile-callout-content-wrap">
            <h3 className="mobile-callout-title">
              Bạn đã tự tin để trở thành Senior Software Engineer?
            </h3>
            <p className="mobile-callout-desc">
